...
!function(t, e) {
  ...
  var e = function() {
    ...
    function B(t) {
      var e, n;
      return c[t] ||
                 (e = f.createElement(t), f.body.appendChild(e),
                  n = getComputedStyle(e, '').getPropertyValue('display'),
                  e.parentNode.removeChild(e), 'none' == n && (n = 'block'), c[t] = n),
             c[t]
    }
    function U(t) {
    ...
    var e, n, r, i, O, P,
        o = [], s = o.concat, a = o.filter, u = o.slice, f = t.document, c = {}, l = {}, h = {
          'column-count': 1,
          columns: 1,
          'font-weight': 1,
          'line-height': 1,
    ...
    return N.matches =
      ...
      var n = t.matches || t.webkitMatchesSelector || t.mozMatchesSelector || t.oMatchesSelector ||
          t.matchesSelector;
      ...
      return o && (i = A).appendChild(t), r = ~N.qsa(i, e).indexOf(t), o && A.removeChild(t), r
             ...
             return d.test(t) && (o = r(f.createElement(RegExp.$1))),
                    o ||
                        (t.replace && (t = t.replace(m, '<$1></$2>')),
                         n === e && (n = p.test(t) && RegExp.$1), n in j || (n = '*'), a = j[n],
                         a.innerHTML = '' + t,
                         o = r.each(
                             u.call(a.childNodes),
                             function() {
           ...
           N.qsa =
               function(t, e) {
             var n, r = '#' == e[0], i = !r && '.' == e[0], o = r || i ? e.slice(1) : e,
                    s = T.test(o);
             return t.getElementById && s && r ?
                 (n = t.getElementById(o)) ? [n] : [] :
                 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType ?
                 [] :
                 u.call(
                     s && !r && t.getElementsByClassName ?
                         i ? t.getElementsByClassName(o) : t.getElementsByTagName(e) :
           ...
           r.type = $, r.isFunction = F, r.isWindow = k, r.isArray = L, r.isPlainObject = Z,
           r.isEmptyObject =
               function(t) {
             var e;
             for (e in t) return !1;
           ...
           r.isNumeric =
             ...
             return null != t && 'boolean' != n && ('string' != n || t.length) && !isNaN(e) &&
                 isFinite(e) ||
                 !1
           },
           r.inArray =
           ...
           r.fn = {
             ...
             ready: function(t) {
               return w.test(f.readyState) && f.body ? t(r) :
                                                       f.addEventListener(
                                                           'DOMContentLoaded',
                                                           function() {
                                                             t(r)
             ...
             not: function(t) {
               ...
               if (F(t) && t.call !== e)
                 ...
                 var i =
                     'string' == typeof t ? this.filter(t) : z(t) && F(t.item) ? u.call(t) : r(t);
             ...
             attr: function(t, r) {
               ...
               return 'string' != typeof t || 1 in arguments ?
                   ...
                   0 in this && 1 == this[0].nodeType && null != (i = this[0].getAttribute(t)) ? i :
                                                                                                 e
             },
             ...
             offset: function(e) {
               ...
               return {
                 left: n.left + t.pageXOffset, top: n.top + t.pageYOffset,
             ...
             scrollTop: function(t) {
               if (this.length) {
                 ...
                 return t === e ? n ? this[0].scrollTop : this[0].pageYOffset :
                                  this.each(n ? function() {
                                    this.scrollTop = t
                                  } : function() {
             ...
             scrollLeft: function(t) {
               if (this.length) {
                 ...
                 return t === e ? n ? this[0].scrollLeft : this[0].pageXOffset :
                                  this.each(n ? function() {
                                    this.scrollLeft = t
                                  } : function() {
             ...
             offsetParent: function() {
               return this.map(function() {
                 for (var t = this.offsetParent || f.body;
           ...
           r.fn.detach = r.fn.remove, ['width', 'height'].forEach(function(t) {
             ...
             r.fn[t] = function(i) {
               ...
               return i === e ?
                   k(s) ? s['inner' + n] :
                          M(s) ? s.documentElement['scroll' + n] : (o = this.offset()) && o[t] :
                   this.each(function(e) {
             ...
             r.fn[n] = function() {
               var n, a, s = r.map(arguments, function(t) {
                 ...
                 return n = $(t),
                        'array' == n ? (t.forEach(function(t) {
                          return t.nodeType !== e ?
                              i.push(t) :
                              r.zepto.isZ(t) ? i = i.concat(t.get()) :
                                               void (i = i.concat(N.fragment(t)))
                        }),
                                        i) :
                                       'object' == n || null == t ? t : N.fragment(t)
               }), u = this.length > 1;
               return s.length < 1 ? this : this.each(function(e, n) {
                 ...
                 s.forEach(function(e) {
                   ...
                   a.insertBefore(e, n),
                       c && tt(e, function(e) {
                         if (!(null == e.nodeName || 'SCRIPT' !== e.nodeName.toUpperCase() ||
                               e.type && 'text/javascript' !== e.type || e.src)) {
  ...
  return t.Zepto = e, void 0 === t.$ && (t.$ = e), function(e) {
    ...
    function p(t, e, n, r) {
      ...
      return (a[h(t)] || []).filter(function(t) {
        return t && (!e.e || t.e == e.e) && (!e.ns || i.test(t.ns)) && (!n || h(t.fn) === h(n)) &&
            (!r || t.sel == r)
      })
    }
    function d(t) {
      ...
      return (n || !t.isDefaultPrevented) &&
                 (n || (n = t),
                  ...
                  (n.defaultPrevented !== r ?
                       n.defaultPrevented :
                       'returnValue' in n ? n.returnValue === !1 :
    ...
    u.click = u.mousedown = u.mouseup = u.mousemove = 'MouseEvents', e.event = {add: y, remove: x},
    ...
    e.fn.on =
      ...
      return t && !s(t) ?
          ...
          (s(n) || o(u) || u === !1 || (u = a, a = n, n = r),
           (u === r || a === !1) && (u = a, a = r), u === !1 && (u = E), h.each(function(r, o) {
             f && (c = function(t) {
               return x(o, t.type, u), u.apply(this, arguments)
             }), n && (l = function(t) {
                   var r, s = e(t.target).closest(n, o).get(0);
                   return s && s !== o ? (r = e.extend(S(t), {currentTarget: s, liveFired: o}),
    ...
    e.fn.triggerHandler =
      ...
      return this.each(function(o, a) {
        r = S(s(t) ? e.Event(t) : t), r._args = n, r.target = a,
    ...
    function y(t, e, n, r) {
      ...
      n.success.call(i, t, o, e), r && r.resolveWith(i, [t, o, e]),
          d(n, i, 'ajaxSuccess', [e, n, t]), b(o, e, n)
    }
    function x(t, e, n, r, i) {
      var o = r.context;
      r.error.call(o, n, e, t), i && i.rejectWith(o, [n, e, t]),
          d(r, o, 'ajaxError', [n, r, t || e]), b(e, n, r)
    }
    function b(t, e, n) {
      var r = n.context;
    ...
    function S(t) {
      t.processData && t.data && 'string' != e.type(t.data) &&
          (t.data = e.param(t.data, t.traditional)),
          !t.data || t.type && 'GET' != t.type.toUpperCase() && 'jsonp' != t.dataType ||
    ...
    function O(t, n, r, i) {
      ...
      e.each(n, function(n, u) {
        ...
        !i && s ? t.add(u.name, u.value) :
                  'array' == o || !r && 'object' == o ? O(t, u, r, n) : t.add(n, u)
      })
    }
    var i, o, n = +new Date, r = t.document,
              s = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
              a = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i,
              f = 'application/json', c = 'text/html', l = /^\s*$/, h = r.createElement('a');
    h.href = t.location.href, e.active = 0,
    e.ajaxJSONP =
        function(i, o) {
      ...
      return o && o.promise(h),
             e(u).on(
                 'load error',
                 function(n, r) {
                   clearTimeout(p), e(u).off().remove(),
                       'error' != n.type && c ? y(c[0], h, i, o) : x(null, r || 'error', h, i, o),
                       t[a] = f, c && e.isFunction(f) && f(c[0]), f = c = void 0
                 }),
             v(h, i) === !1 ? (l('abort'), h) :
                              (t[a] =
                                   function() {
                               ...
                               r.head.appendChild(u), i.timeout > 0 && (p = setTimeout(function() {
                                                                          l('timeout')
                                                                        }, i.timeout)), h)
    },
    e.ajaxSettings = {
    ...
    e.ajax = function(n) {
      ...
      m(s),
          s.crossDomain ||
          (u = r.createElement('a'), u.href = s.url, u.href = u.href,
           s.crossDomain = h.protocol + '//' + h.host != u.protocol + '//' + u.host),
          s.url || (s.url = t.location.toString()),
          (f = s.url.indexOf('#')) > -1 && (s.url = s.url.slice(0, f)), S(s);
      ...
      if (p && (c = 'jsonp'),
        ...
        return p ||
                   (s.url =
                        T(s.url, s.jsonp ? s.jsonp + '=?' : s.jsonp === !1 ? '' : 'callback=?')),
               e.ajaxJSONP(s, a);
      var P, d = s.accepts[c], g = {},
             b =
                 function(t, e) {
               g[t.toLowerCase()] = [t, e]
             },
      ...
      if (a && a.promise(N), s.crossDomain || b('X-Requested-With', 'XMLHttpRequest'),
          b('Accept', d || '*/*'),
          (d = s.mimeType || d) &&
    ...
    t.fn.serializeArray = function() {
      ...
      return this[0] && t.each(this[0].elements, function(r, o) {
        n = o.type, e = o.name,
        e && 'fieldset' != o.nodeName.toLowerCase() && !o.disabled && 'submit' != n &&
            'reset' != n && 'button' != n && 'file' != n &&
            ('radio' != n && 'checkbox' != n || o.checked) && i(t(o).val())
      }), r
