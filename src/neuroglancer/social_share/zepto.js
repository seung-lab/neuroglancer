...
var Zepto = (function() {
  var undefined, key, $, classList,
      ...
      slice = emptyArray.slice, document = window.document, elementDisplay = {}, classCache = {},
      cssNumber = {
        'column-count': 1,
        'columns': 1,
        'font-weight': 1,
  ...
  $ =
        ...
        for (key in source)
          if (deep && (isPlainObject(source[key]) || isArray(source[key]))) {
            if (isPlainObject(source[key]) && !isPlainObject(target[key]))
              target[key] = {} if (isArray(source[key]) && !isArray(target[key]))
              target[key] = []
    ...
    return (element.getElementById && isSimple &&
            maybeID) ?  // Safari DocumentFragment doesn't have getElementById
        ((found = element.getElementById(nameOnly)) ? [found] : []) :
        (element.nodeType !== 1 && element.nodeType !== 9 && element.nodeType !== 11) ?
        [] :
        slice.call(
            isSimple && !maybeID &&
                    element.getElementsByClassName ?  // DocumentFragment doesn't have
  ...
  $.isEmptyObject =
    ...
    return val != null && type != 'boolean' && (type != 'string' || val.length) && !isNaN(num) &&
        isFinite(num) ||
        false
  }
  ...
  $.fn = {
    ...
    concat: function() {
      var i, value, args = [] for (i = 0; i < arguments.length; i++) {
        value = arguments[i]
    ...
    not: function(selector) {
      var nodes =
        ...
        var excludes = typeof selector == 'string' ?
            ...
            slice.call(selector) :
            $(selector) this.forEach(function(el) {
    ...
    find: function(selector) {
      var result, $this = this if (!selector) result = $()
    ...
    closest: function(selector, context) {
      var nodes = [],
          collection = typeof selector == 'object' && $(selector) this.each(function(_, node) {
            while (node &&
    ...
    parents: function(selector) {
      var ancestors = [], nodes = this while (nodes.length > 0)
    ...
    show: function() {
      return this.each(function() {
        ...
        if (getComputedStyle(this, '').getPropertyValue('display') == 'none') this.style.display =
    ...
    text: function(text) {
      return 0 in arguments ? this.each(function(idx) {
        var newText = funcArg(this, text, idx, this.textContent) this.textContent =
    ...
    attr: function(name, value) {
      ...
      return (typeof name == 'string' && !(1 in arguments)) ?
          ...
          this.each(function(idx) {
            if (this.nodeType !== 1)
              return if (isObject(name)) for (key in name) setAttribute(this, key, name[key])
    ...
    offset: function(coordinates) {
      if (coordinates)
        ...
        return {top: 0, left: 0} var obj = this[0].getBoundingClientRect()
        return {
          left: obj.left + window.pageXOffset, top: obj.top + window.pageYOffset,
    ...
    css: function(property, value) {
      if (arguments.length < 2) {
        var element = this[0] if (typeof property == 'string') {
          if (!element)
            return return element.style[camelize(property)] ||
                getComputedStyle(element, '').getPropertyValue(property)
        }
        else if (isArray(property)) {
          if (!element) return var props = {} var computedStyle = getComputedStyle(element, '')
    ...
    addClass: function(name) {
      if (!name)
        return this return this.each(function(idx) {
          if (!('className' in this))
            return classList = [] var cls = className(this), newName = funcArg(this, name, idx, cls)
    ...
    removeClass: function(name) {
      return this.each(function(idx) {
        if (!('className' in this)) return if (name === undefined) return className(this, '')
      ...
      if (!name)
        return this return this.each(function(idx) {
          ...
          names.split(/\s+/g).forEach(function(klass) {
            (when === undefined ? !$this.hasClass(klass) : when) ? $this.addClass(klass) :
    ...
    scrollTop: function(value) {
      if (!this.length)
        return var hasScrollTop =
                   'scrollTop' in this[0] if (value === undefined) return hasScrollTop ?
            this[0].scrollTop :
            this[0].pageYOffset
    ...
    scrollLeft: function(value) {
      if (!this.length)
        return var hasScrollLeft =
                   'scrollLeft' in this[0] if (value === undefined) return hasScrollLeft ?
            this[0].scrollLeft :
            this[0].pageXOffset
  ...
  ['width', 'height'].forEach(function(dimension) {
    ...
    $.fn[dimension] = function(value) {
      var offset,
          el = this[0] if (value === undefined) return isWindow(el) ?
          el['inner' + dimensionProperty] :
          isDocument(el) ?
          el.documentElement['scroll' + dimensionProperty] :
          (offset = this.offset()) && offset[dimension] else return this.each(function(idx) {
            el = $(this)
...
window.$ === undefined && (window.$ = Zepto)
    ...
    ;
(function($) {
var _zid = 1, undefined, slice = Array.prototype.slice, isFunction = $.isFunction,
    isString =
        function(obj) {
...
function findHandlers(element, event, fn, selector) {
  ...
  return (handlers[zid(element)] || []).filter(function(handler) {
    return handler && (!event.e || handler.e == event.e) &&
        (!event.ns || matcher.test(handler.ns)) && (!fn || zid(handler.fn) === zid(fn)) &&
  ...
  events.split(/\s/).forEach(function(event) {
    if (event == 'ready') return $(document).ready(fn)
      ...
      handler.proxy = function(e) {
        ...
        if (result === false) e.preventDefault(), e.stopPropagation() return result
...
function remove(element, events, fn, selector, capture) {
  ...
  (events || '').split(/\s/).forEach(function(event) {
    findHandlers(element, event, fn, selector).forEach(function(handler) {
      delete handlers[id][handler.i] if ('removeEventListener' in element)
  ...
  return true
   ...
   eventMethods =
       ...
       function createProxy(event) {
         var key, proxy = {originalEvent: event} for (key in event)
         ...
         return this.each(function() {
           ...
           if (event.type in focus && typeof this[event.type] == 'function') this[event.type]()
             // items in the collection might not be DOM elements
                                   ...
                                   // triggers event handlers on current element just as if an event
                                   // occurred, doesn't trigger an actual event, doesn't bubble
                                   $.fn.triggerHandler =
                                       function(event, args) {
...
$.Event = function(type, props) {
  if (!isString(type)) props = type, type = props.type
    ...
    if (props) for (var name in props)(name == 'bubbles') ? (bubbles = !!props[name]) :
    ...
    ;
(function($) {
var jsonpID = +new Date(), document = window.document, key, name,
...
$.ajaxJSONP =
  ...
  if (!('type' in options)) return $.ajax(options)
    ...
    var _callbackName = options.jsonpCallback,
        ...
        ('Zepto' + (jsonpID++)),
        script = document.createElement('script'), originalCallback = window[callbackName],
    ...
    $(script).on('load error', function(e, errorType) {
      ...
      else {ajaxSuccess(responseData[0], xhr, options, deferred)}
  ...
  return xhr
    ...
    $.ajaxSettings =
        ...
        function mimeToDataType(mime) {
          if (mime)
            mime = mime.split(';', 2)[0] return mime &&
                    (mime == htmlType ?
                         'html' :
                         mime == jsonType ?
                         'json' :
        ...
        $.ajax =
          ...
          if (!settings.url) settings.url = window.location.toString()
            if ((hashIndex = settings.url.indexOf('#')) > -1) settings.url =
                settings.url.slice(0, hashIndex)
                ...
                if ((xhr.status >= 200 && xhr.status < 300) || xhr.status == 304 ||
                  ...
                  result = xhr.response
                    ...
                    try {
                      ...
                      else if (dataType == 'json') result =
                          blankRE.test(result) ? null : $.parseJSON(result)
                    } catch (e) {
                      error = e
                    }
                  ...
                  ajaxError(
                      xhr.statusText || null, xhr.status ? 'error' : 'abort', xhr, settings,
                      deferred)
                }
              }
            }
          ...
          if (settings.xhrFields) for (name in settings.xhrFields) xhr[name] =
              settings
                  .xhrFields[name]
          ...
          return $.ajax(options)
                        ...
                        $.fn.load =
                            function(url, data, success) {
          if (!this.length)
            return this var self = this, parts = url.split(/\s/), selector,
                            options = parseArguments(url, data, success), callback = options.success
            if (parts.length > 1) options.url = parts[0], selector = parts[1]
            options.success = function(response) {
              self.html(
                  selector ? $('<div>').html(response.replace(rscript, '')).find(selector) :
                             response)
...
$.param = function(obj, traditional) {
  ...
  params.add = function(key, value) {
    if ($.isFunction(value)) value = value()
      if (value == null) value = '' this.push(escape(key) + '=' + escape(value))
...
$.fn.serializeArray =
  ...
  var name, type, result = [], add = function(value) {
    ...
    if (name && field.nodeName.toLowerCase() != 'fieldset' && !field.disabled && type != 'submit' &&
        type != 'reset' && type != 'button' && type != 'file' &&
  ...
  if (0 in arguments)
    this.bind('submit', callback)
      ...
      var event = $.Event('submit') this.eq(0).trigger(event)
