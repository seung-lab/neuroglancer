...
Socials.prototype = {
  ...
  showLabel: function(screenWidth) {
    return (this.showCount === false) ? (screenWidth > this.smallScreenWidth) :
  ...
  _createShareLink: function(share) {
    ...
    var $result = shareStrategy.call(share, {shareUrl: this._getShareUrl(share)});
  ...
  _createShareLogo: function(share) {
    ...
    var $result =
        IMG_SRC_REGEX.test(logo) ? $('<img>').attr('src', share.logo) : $('<i>').addClass(logo);
