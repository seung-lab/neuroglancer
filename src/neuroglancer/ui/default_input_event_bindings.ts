    ...
    defaultRenderedDataPanelBindings = EventActionMap.fromObject(
        {
          ...
          'comma': 'z-',
          'period': 'z+',
          'shift+comma': {action: 'z+-10-via-wheel', preventDefault: true},
          'shift+period': {action: 'z+10-via-wheel', preventDefault: true},
          'control+shift+comma': {action: 'z+-100-via-wheel', preventDefault: true},
          'control+shift+period': {action: 'z+100-via-wheel', preventDefault: true},
          'control+alt+shift+comma': {action: 'z+-1000-via-wheel', preventDefault: true},
          'control+alt+shift+period': {action: 'z+1000-via-wheel', preventDefault: true},
          'keyz': 'snap',
